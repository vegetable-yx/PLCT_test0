...
- [logs文件夹](https://github.com/vegetable-yx/PLCT_test0/tree/main/issue_check/result/logs)：所有测试用例的日志文件  

- [logs_failed文件夹](https://github.com/vegetable-yx/PLCT_test0/tree/main/issue_check/result/logs_failed)：所有未通过测试用例的日志文件  

- [result.csv](https://github.com/vegetable-yx/PLCT_test0/tree/main/issue_check/result/result.csv):测试结果的详细数据统计  

- [failureCause.csv](https://github.com/vegetable-yx/PLCT_test0/tree/main/issue_check/result/failureCause.csv)：测试未通过原因的初步分析和归类  
...
- 由于未通过测试较多，我们对测试结果进行了初步的分类和归因，具体结果在[failureCause.csv](https://github.com/vegetable-yx/PLCT_test0/tree/main/issue_check/result/failureCause.csv)文件中  
